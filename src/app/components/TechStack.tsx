...
const technologies = [
  ...
  { name: "Go", category: "Backend", color: "text-blue-400" },
  {
    name: "PHP",
    category: "Backend",
  ...
  { name: "PyTorch", category: "AI/ML", color: "text-red-500" },
  {
    name: "OpenAI",
    category: "AI/ML",
    color: "text-green-500",
  },
  { name: "Arduino", category: "IoT", color: "text-teal-400" },
  {
    name: "Raspberry Pi",
    category: "IoT",
    color: "text-pink-400",
  },
  { name: "MQTT", category: "IoT", color: "text-purple-400" },
  {
    name: "MongoDB",
    category: "Database",
    color: "text-green-500",
  ...
  { name: "Azure", category: "Cloud", color: "text-blue-500" },
  {
    name: "Google Cloud",
    category: "Cloud",
    color: "text-yellow-400",
